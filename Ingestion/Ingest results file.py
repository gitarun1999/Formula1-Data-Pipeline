...
results_schema = StructType(fields=[StructField("resultId",IntegerType(),False),
                                    ...
                                    StructField("gridd",IntegerType(),True),
...
.json("/mnt/formuladl9032/raw/results.json")
...
results_final_df.write.mode("overwrite").partitionBy('race_id').parquet("/mnt/formuladl9032/processed/results")
